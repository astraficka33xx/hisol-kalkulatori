...
(function () {
  ...
  var en = {
    ...
    home: {
      ...
      blogTeaser1Title: "Why Albania is a good place for solar panels",
      blogTeaser1Body: "When talking about solar energy, Germany is often mentioned as one of the countries with the most panels in Europe. But a panel in Albania produces far more energy…",
      blogTeaser1Read: "4 min read",
      blogTeaser2Title: "How quickly does the investment in solar panels pay off?",
      blogTeaser2Body: "The most common question we get is how many years it takes for the investment to pay off. It's a reasonable question, since every investment is also judged by its payback time.",
      blogTeaser2Read: "5 min read",
      blogTeaser3Title: "Panels produce even when it's cloudy",
      blogTeaser3Body: "Do panels produce when the sky is cloudy? The answer is yes. Output is lower, but it doesn't stop.",
      blogTeaser3Read: "3 min read",
